...
public sealed class WorkbenchAcceptanceHarness
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new WorkbenchAcceptanceReceipt(
            "matawaka.workbench-acceptance-receipt/v0.27",
            "0.27.0",
            runId,
            DateTimeOffset.Now,
            passed,
