...
Независимые задания для Grok и Claude находятся в [review/README.md](review/README.md). Ответы этих моделей ожидаются от оператора; отсутствие ответа не означает PASS. Технический AI review не является HUMAN_ADJUDICATED reference.
