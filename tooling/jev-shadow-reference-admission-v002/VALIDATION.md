...
Initial CI run `35695357766` at `2a2be0256ea8386a30d60b69a578461d987558e0`: Ubuntu passed all 112 tests; Windows passed all 36 baseline tests and 69/76 successor tests. Seven filesystem/CLI tests hit the intentional REALPATH_ALIAS_REFUSED guard while using the runner temporary directory. The synthetic fixture helper now resolves the temporary root with realpath before creating inputs. Production path checks and negative tests remain unchanged. Final CI results are linked in the Draft PR.
